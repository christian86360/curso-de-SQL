...
------CREACIÓN TABLAS E INSERCIÓN DE DATOS
...
--1. Obtener los datos de las etapas que pasan por algún puerto de montaña y que tienen salida y
...
--5. Obtener el número de las etapas que tienen algún puerto de montaña, indicando cuántos
...
---6. Obtener el nombre y la edad de los ciclistas que han llevado dos o más maillots en una misma
--etapa.
...
--7. Obtener el nombre y el equipo de los ciclistas que han llevado algún maillot o que han ganado
--algún puerto.
...
--9. Obtener el código y el color de aquellos maillots que sólo han sido llevados por ciclistas de un
--mismo equipo.
...
--12. Obtener el nombre de los puertos de montaña que tienen una altura superior a la altura
...
--16. Obtener el nombre de los ciclistas que pertenecen a un equipo de más de cinco ciclistas y que han ganado alguna etapa, indicando también cuántas etapas han ganado.
...
--17.Octener el nombre y el equpo de los ciclistas menores de 30 añoas que hayan ganado una etapa(deven salir 6)
...
--18.Octener el nombre y el equpo de los ciclistas mayores de 32 años que allan ganado algun puerto(salir 2)
...
--19.Octener los datos de las etapas que pasan por algun puerto de montaña que tiene salida y llegada en la misma poblacion(1)
